...
class InactiveTripAdapter(val context : Context, val dayTripData : ArrayList<BringCourseResponse>) : RecyclerView.Adapter<InactiveTripAdapter.ViewHolder>() {
    ...
    override fun getItemCount(): Int {
        return dayTripData.count { it.status == "INACTIVE" }
    }
